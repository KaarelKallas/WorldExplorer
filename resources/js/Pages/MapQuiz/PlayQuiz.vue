...
<template class="whitespace-nowrap overflow-hidden w-24 scrollbar-none">
    ...
    <l-map :use-global-leaflet="true" ref="map" v-model:zoom="zoom" :center="[47.41322, -1.219482]"  @click="gMark">
        <l-tile-layer
        url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        layer-type="base"
        name="OpenStreetMap"
      ></l-tile-layer>
      <l-marker :lat-lng="[coords.lat, coords.lng]" draggable> </l-marker>
    </l-map>
      ...
      :path="[{lat:form.lat, lng:form.lng}, {lat:location.lat, lng:location.lng}]"
       ...
       <GMapMarker :icon="guessIcon"  :position="{lat:form.lat, lng:form.lng}">
        ...
        <div class="absolute z-10 top-0 inset-x-96 flex justify-between filter backdrop-blur-md bg-gray-300/30 p-5 items-center align-center rounded-b-3xl">
